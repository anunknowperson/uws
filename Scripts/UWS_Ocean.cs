...
public class UWS_Ocean : UWS_WaterObject
{
    ...
    {
        List<UWS_Renderer.Property> real = UWS_WaterDomain.s_Instance._renderer.GetOceanProperties();
    ...
    private IEnumerator Registration()
    {
        ...
        {
            RendererSettings = UWS_WaterDomain.s_Instance._renderer.GetOceanProperties();
        }

        _material = UWS_WaterDomain.s_Instance._renderer.GetOceanMaterial();
    ...
    public override Path GetPolygon()
    {
        ...
        float sd2 = UWS_WaterDomain.s_Instance.Scale / 2.0f;

        points.Add(new IntPoint(-sd2 * 1000, sd2 * 1000));
        points.Add(new IntPoint(sd2 * 1000, sd2 * 1000));
        points.Add(new IntPoint(sd2 * 1000, -sd2 * 1000));
        points.Add(new IntPoint(-sd2 * 1000, -sd2 * 1000));
